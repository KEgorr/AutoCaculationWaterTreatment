      ...
      >
        <div className={isHide}>
          ...
          <p>
            ...
            более 0,02 мг/дм³, при массовой концентрации кислорода до деаэрации
            не более 2 мг/дм³.
          </p>
          <p>
          ...
          <p>
            ...
            вода собирается в баке Деаэратора. Емкость бака обеспечивает работу
            в течение 12–15 мин. без поступлений конденсата и пара, благодаря
            чему регулируется питание котла на переменных режимах.
          </p>
          <p>
            К данной схеме ВПУ предложен деаэратор {deaerator.name} атмосферного
            давления, на основании производительности деаэратора, близкой к
            производительности ВПУ = {performance}{' '}
