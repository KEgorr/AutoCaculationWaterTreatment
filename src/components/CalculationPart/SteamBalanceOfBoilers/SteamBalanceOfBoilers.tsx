...
export default function SteamBalanceBoilers() {
  ...
  const QPkFormula = `\\tag{1} ${Q_pk} = k${q3} + ${q4} + ${q5} + ${q6} + ${q7} + ${q8} + P\\frac{${G1}}{100}, ${TChasDimension},`;
  ...
  return (
    <div>
      ...
      >
        Паровой (тепловой) баланс котельной установки
      </h2>
      <div className={isHidden ? 'calc-block block-hidden' : 'calc-block'}>
        <div className="calc-block__content">
          <p>Паровой баланс котельной представлен в таблице 1</p>
          <div>
          ...
          <p>
            ...
            установки находится по формуле 1:
          </p>
